...
const int N = 7;
int RebinFact;
int RebinFacts[N] = {10, 10, 8, 5, 2, 1, 4};
TString Variable;
TString Variables[N] = {"MET_", "DeltaPhi_lepton_MET_", "MET_phi_", "METsignificance_", "Angle_lepton_MET_jets_", "Transverse_Mass_MET20_", "Transverse_Mass_"};
// double MinXs[N] = {0,-2.6 ,0 , 0, -3.4, 0};
// double MaxXs[N] = {2.6,2.6 ,0.5 , 400,3.2 , 0.3};
TString XTitles[N] = {"#slash{E}_{T}", "#Delta#phi(l, MET)", "#phi(#slash{E}_{T})", "#sigma", "#theta(MET,jets)", "M_{T}(MET)", "M_{T}(MET)"};
