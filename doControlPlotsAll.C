...
void doControlPlotsAll::makeAllPlots(){

	PhotonPlots(); // With requirement of >=1 photon. Change flags for n-1 selection plots. 
	DiLeptonsPlots(); // Before requirement of >=1 photon.
	METPlots(); 
	JETPlots();
	
}

void doControlPlotsAll::PhotonPlots(){
...
int RebinFacts[N] = {20, 20, 5, 5, 2, 2, 5, 5, 25, 1, 5, 1, 20, 20}; //SignalPhotons PassesCutsUpToOnePhoton1Btag  
//int RebinFacts[N] = {12, 11, 3, 3, 2, 2, 6, 6, 12, 16, 4, 4, 2}; //AllPhotons PassesCutsUpTo1Btag Muons
//int RebinFacts[N] = {58, 40, 18, 18, 5, 5, 5, 5, 36, 50, 9, 8, 3}; //SignalPhotons PassesCutsUpTo1Btag Muons
...
void doControlPlotsAll::DiLeptonsPlots(){
...
void doControlPlotsAll::METPlots(){
...
void doControlPlotsAll::JETPlots(){
